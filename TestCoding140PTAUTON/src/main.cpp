...
void autonomous(void) {
  ...
  Inertial.setRotation(275, rotationUnits::deg);
  rotatePID(5, right);
  //rotatePID(360, right);
...
//Spins so that the robot is aligned
  ...
  Left.spinFor(forward, INCH * 42.5, degrees, false);
  Right.spinFor(forward, INCH * 42.5, degrees);
  Left.spinFor(reverse, 650, degrees, false);
  Right.spinFor(forward, 650, degrees);
  Left.spinFor(forward, 13 * INCH, degrees, false);
  Right.spinFor(forward, 13 * INCH, degrees, false);
  wait(3, seconds);
  ...
  Left.spinFor(forward, 25 * INCH, degrees, false);
  Right.spinFor(forward, 25 * INCH, degrees);
  wait(0.5, seconds);
  tilter.spinFor(405, degrees, false);
  wait(3, seconds);
  Left.setVelocity(40, velocityUnits::pct); 
  ...
  Left.spinFor(reverse, 850, degrees, false);
  Right.spinFor(forward, 850, degrees);
  Left.spinFor(forward, 27 * INCH, degrees, false);
  Right.spinFor(forward, 27 * INCH, degrees, false);
  wait(3, seconds);
  tilter.spinFor(405, degrees, false);
  wait(3, seconds);
  ...
  Left.spinFor(reverse, 1010, degrees, false);
  Right.spinFor(forward, 1010, degrees);
  wait(1, seconds);

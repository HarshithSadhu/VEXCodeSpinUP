...
void autonomous(void) {
  ...
  if(Vision1.largestObject.exists){
    Brain.Screen.print(Vision1.largestObject.originX);
  }
...
//Spins so that the robot is aligned
  ...
  //rotatePID(-31, right);
  Left.spinFor(reverse, 1070, degrees, false);
  Right.spinFor(forward, 1070, degrees);
  ...
  Left.spinFor(forward, INCH * 29.5, degrees, false);
  Right.spinFor(forward, INCH * 29.5, degrees);
  ...
  //rotatePID(116.5, right);

  while(Inertial.rotation() < 112.5){
    Right.spin(reverse, 5, voltageUnits::volt);
    Left.spin(forward, 5, voltageUnits::volt);
  }
  //wait(60, seconds);
  Left.stop(brake);
  Right.stop(brake);
  ...
  Left.setVelocity(40, velocityUnits::pct); 
  Right.setVelocity(40, velocityUnits::pct);
  Left.spinFor(forward, 33 * INCH, degrees, false);
  Right.spinFor(forward, 33 * INCH, degrees, false);
  wait(3, seconds);
  tilter.spinFor(405, degrees, false);
  wait(3, seconds);
  ...
  Left.setVelocity(50, velocityUnits::pct); 
  Right.setVelocity(50, velocityUnits::pct);
  Left.spinFor(reverse, 10 * INCH, degrees, false);
  Right.spinFor(reverse, 10 * INCH, degrees);

  while(Inertial.rotation() < 110){
    Right.spin(reverse, 5, voltageUnits::volt);
    Left.spin(forward, 5, voltageUnits::volt);
  }
  ...
  Left.spinFor(forward, 100 * INCH, degrees, false);
  Right.spinFor(forward, 100 * INCH, degrees);
  ...
  Left.setVelocity(100, velocityUnits::pct); 
  Right.setVelocity(100, velocityUnits::pct);
  Left.spinFor(reverse, 100 * INCH, degrees, false);
  Right.spinFor(reverse, 100 * INCH, degrees);

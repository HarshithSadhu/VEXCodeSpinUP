...
void spinRoller(){
  ...
  while(isLooking){
    ...
    if(Vision20.largestObject.exists){// && startTimer <= 1500){
...
void autonomous(void) {
  ...
  Inertial.setHeading(1, degrees);
    ...
    leftDrive.spinFor(reverse, 1800, degrees, false);
    rightDrive.spinFor(reverse, 1800, degrees);
    ...
    leftDrive.spinFor(reverse, 120, degrees, false);
    rightDrive.spinFor(forward, 120, degrees);
  ...
  leftDrive.spinFor(reverse, 30, degrees, false);
  rightDrive.spinFor(reverse, 30, degrees);
